...
export default function Projects() {
    ...
    return (
        <div id="projects" className="min-h-screen w-full px-8 flex flex-col items-center">
            <h1 className="text-5xl font-extrabold text-center text-gray-100 mb-12">
                Projects
            </h1>

            {/* Archivum Section */}
            <div className="w-full max-w-7xl text-left mb-16 bg-gray-900/40 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border border-gray-700/30 fade-up">
